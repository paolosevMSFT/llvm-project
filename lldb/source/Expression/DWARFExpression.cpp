...
bool DWARFExpression::Evaluate(ExecutionContext *exe_ctx,
  ...
  DWARFEvaluatorFactory *evaluator_factory = nullptr;
  if (module_sp) {
    evaluator_factory = module_sp->GetDWARFExpressionEvaluatorFactory();
  } else {
    static DWARFEvaluatorFactory default_evaluator_factory;
